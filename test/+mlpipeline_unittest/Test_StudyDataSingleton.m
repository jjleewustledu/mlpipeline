	...
	methods (Test)
		...
		function test_testRaichle(this)
            ...
            this.verifyEqual(nxt.tof_fqfn, ...
                fullfile(this.testsDir, 'raichle/PPGdata/idaif/NP995_14/V1/NP995_14_TOF.4dfp.nii.gz'));
            this.verifyEqual(nxt.T1_fqfn, ...
		...
		function test_mlraichle(this)
            ...
            this.verifyEqual(nxt.tof_fqfn, ...
                fullfile(this.studiesDir, 'raichle/PPGdata/idaif/HYGLY08/V1/HYGLY08_TOF.4dfp.nii.gz'));
            this.verifyEqual(nxt.T1_fqfn, ...
